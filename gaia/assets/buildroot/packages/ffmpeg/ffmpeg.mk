...
# Upstream ffmpeg.org git endpoint is intermittently unavailable (HTTP 502).
# Use the canonical GitHub mirror for reliability.
FFMPEG_SITE = https://github.com/FFmpeg/FFmpeg.git
FFMPEG_SITE_METHOD = git
FFMPEG_INSTALL_STAGING = YES
FFMPEG_CPE_ID_VERSION = 8.0.1
